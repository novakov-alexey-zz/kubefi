...
use anyhow::Result;
use k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::{CustomResourceDefinition, CustomResourceDefinitionSpec, CustomResourceDefinitionVersion, CustomResourceValidation, JSONSchemaProps};
use kube::Api;
...
#[kube(group = "io.github.novakov-alexey", version = "v1", namespaced, shortname = "nidp")]
...
pub async fn create_new_version(crds: Api<CustomResourceDefinition>, json_schema: String) -> Result<()> {
